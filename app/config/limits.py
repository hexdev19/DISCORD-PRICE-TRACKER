...
VALIDATION_RECENT_SNAPSHOTS: Final[int] = _env_int("LIMIT_VALIDATION_RECENT_SNAPSHOTS", 10)
VALIDATION_MIN_HISTORY: Final[int] = _env_int("LIMIT_VALIDATION_MIN_HISTORY", 3)
VALIDATION_PRICE_BAND_FACTOR: Final[float] = _env_float("LIMIT_VALIDATION_PRICE_BAND_FACTOR", 3.0)
VALIDATION_MAGNITUDE_RATIO: Final[float] = _env_float("LIMIT_VALIDATION_MAGNITUDE_RATIO", 10.0)
VALIDATION_SUSPECT_CONFIDENCE: Final[float] = _env_float("LIMIT_VALIDATION_SUSPECT_CONFIDENCE", 0.6)
VALIDATION_ARBITRATE_CONFIDENCE: Final[float] = _env_float(
    "LIMIT_VALIDATION_ARBITRATE_CONFIDENCE", 0.3
)

AI_FALLBACK_COOLDOWN_SECONDS: Final[int] = _env_int("LIMIT_AI_FALLBACK_COOLDOWN", 6 * 60 * 60)
AI_FALLBACK_TIMEOUT_MS: Final[int] = _env_int("LIMIT_AI_FALLBACK_TIMEOUT_MS", 120_000)
AI_FALLBACK_CACHE_TTL_SECONDS: Final[int] = _env_int("LIMIT_AI_FALLBACK_CACHE_TTL", 24 * 60 * 60)

ALERT_MIN_CONFIDENCE: Final[float] = _env_float("LIMIT_ALERT_MIN_CONFIDENCE", 0.6)
ALERT_MIN_DROP_RATIO: Final[float] = _env_float("LIMIT_ALERT_MIN_DROP_RATIO", 0.02)
